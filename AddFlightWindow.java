...
public class AddFlightWindow extends JFrame implements ActionListener {
    ...
    private JTextField capacityText = new JTextField(); // Added for capacity
    ...
    private void initialize() {
        ...
        setSize(350, 250); // Increased height to accommodate capacity field
        JPanel topPanel = new JPanel();
        topPanel.setLayout(new GridLayout(6, 2)); // Increased rows to 6 for capacity field
        ...
        topPanel.add(new JLabel("Capacity : ")); // Added for capacity
